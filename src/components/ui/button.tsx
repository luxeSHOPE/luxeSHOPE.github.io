  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-fashion-charcoal text-primary-foreground hover:bg-fashion-charcoal/90 shadow-product hover:shadow-hover transition-spring",
        accent: "bg-gradient-accent text-accent-foreground hover:scale-105 transition-spring shadow-elegant",
        gold: "bg-gradient-gold text-fashion-gold-foreground hover:scale-105 transition-spring shadow-elegant",
      },
      size: {
